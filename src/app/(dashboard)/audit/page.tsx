...
const actionTypes = [
  ...
  { value: "SUBSCRIPTION_UPDATED", label: "Suscripción actualizada" },
  { value: "SUBSCRIPTION_CANCELLED", label: "Suscripción cancelada" },
  { value: "SUBSCRIPTION_DELETED", label: "Suscripción eliminada" },
  { value: "CLASS_CREATED", label: "Clase creada" },
  { value: "CLASS_UPDATED", label: "Clase actualizada" },
  { value: "CLASS_DELETED", label: "Clase eliminada" },
  { value: "CLASS_ATTENDANCE_MARKED", label: "Asistencia marcada" },
  { value: "MODULE_CREATED", label: "Módulo creado" },
  { value: "LESSON_CREATED", label: "Lección creada" },
  { value: "CHALLENGE_CREATED", label: "Desafío creado" },
  { value: "SUBMISSION_REVIEWED", label: "Envío revisado" },
  { value: "JOB_CREATED", label: "Trabajo creado" },
  { value: "SYSTEM_CONFIG_UPDATED", label: "Configuración actualizada" },
